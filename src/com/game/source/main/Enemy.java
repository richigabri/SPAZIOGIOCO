...
public class Enemy extends GameObject implements EntityEnemy{
	...
	int score=0;
	//variabile speed per la velocit� dei nemici casuale
	...
	public void tick() {
		...
		if(y > (Game.HEIGHT * Game.SCALE)) {
			y = 0;
			//una volta che ripartono li rallento ma continuo a farli andare a una velocit� random
			speed = r.nextInt(2)+ 1;
		...
		for (int i = 0; i < game.ef.size(); i++) {
			...
			//Creo una entit� temporanea e controllo che non collida col nemico
