...
public class Animation {
	...
	/*	velocità dell'animazione, indice per tenere conto di dove siamo 
	 * 	con l'animazione e count per considerare il numero massimo 
	 * 	di passaggi prima del loop */
	private int speed;
	private int frames;
	private int index = 0;
	private int count = 0;
	
	//ciascuna delle possibili immagini della nostra animazione
	...
	//immagine visualizzata al momento 
	private BufferedImage currentImg;
	
	/*	D'ora in poi avrò i metodi dove varia il numero di frame e quindi di immagini dell'animazione
	 *	Sono stati ripetuti invece che usare un unico if perchè così collego esattamente il numero di immagini dell'animazione
	 *	(ad esempio in una animazione da 10 frame le immagini 11, 12 13 e cosi via dovrebbero non venire inizializzate);
	 *	
	 *	Richiedono tutte la velocità e ogni immagine da associare
	 * */
	...
	/* Funzione di base per far andare le animazioni : aumentando un contatore dopo un tot di tempo prefissato
	 * cambia l'immagine chiamando la funzione NextFrame
	 * */
	...
	/* Questa funzione in base al numero di frame si occupa tramite switch di cambiare l'immagine della animazione con quella corretta
	 * e avendola scritta in questo metodo risulta universale se chiamate correttamente le due funzioni precedenti
	 * */
	...
	//serve a disegnare le animazioni che abbiamo così creato
	public void drawAnimation(Graphics g, double x, double y, int offset){
		g.drawImage(currentImg, (int)x - offset, (int)y, null);
	}
	
	//getter & setter di Count e Speed che ci torneranno utili
